...
public class Puzzle {
    ...
    public static void puzzle2() {
        System.out.println("\n------------------------------------------------------------------");
        System.out.println("System:");
        System.out.println("A train is experiencing overcrowding and you need to determine whether\n it´s safe to allow more passengers onboard.");
    ...
    public static void puzzle3() {
        ...
        if(choice == 1){
            ...
            System.out.println("You synced the display system and the departure board now shows \naccurate train times");
            System.out.println("--------------------------->press enter to continue");
